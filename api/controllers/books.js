...
var modelInstance = require( '../models/books-model' );
...
exports.index = function( req, res ) {
	...
	if( req.params.type != undefined ) conditions += ' AND Book.book_type = "' + req.params.type + '" ';
...
exports.detail = function( req, res ) {
	...
	if ( validation.checkInt( id ) ) {
		...
		var conditions = [ 'Book.id', 'Book.row_status' ];
